...
$result_cursos = "SELECT * FROM usuarios WHERE nome LIKE '%$pesquisar%' LIMIT 6";
...
<div class="holder">
<div class="imagem">
<img id="img_redonda" src="<?php echo "documentos/".$rows_cursos['arquivo'] ?>"width="200px" height="200px float="right""><br><br>
